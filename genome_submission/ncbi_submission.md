...
printf \
"CGMCC3 PRJNA532407 CGMCC3_17371" \
> genome_submission/Cf_PRJNA532407_locus_tags.txt
```
...
for Assembly in $(ls repeat_masked/*/*/filtered_contigs/*_contigs_softmasked_repeatmasker_TPSI_appended.fa); do
    ...
    echo "$Organism - $Strain"
    OutDir="genome_submission/$Organism/$Strain"
    LocusTag=$(cat genome_submission/Cf_PRJNA532407_locus_tags.txt | grep "$Strain" | cut -f1 -d ' ')
    echo $LocusTag
...
for Assembly in $(ls repeat_masked/*/*/filtered_contigs/*_contigs_softmasked_repeatmasker_TPSI_appended.fa); do
  Strain=$(echo $Assembly| rev | cut -d '/' -f3 | rev)
  Organism=$(echo $Assembly | rev | cut -d '/' -f4 | rev)
  Taxon="Colletotrichum fructicola"
  echo "$Organism - $Strain"
  OutDir="genome_submission/$Organism/$Strain"
